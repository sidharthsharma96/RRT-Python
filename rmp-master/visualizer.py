...
class Visualizer:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if start_pos == end_pos:
                        ...
                        pygame.draw.rect(self.screen, self.BLUE, start_pos + (width, height))
                        pygame.display.update()
                # On press ENTER draw the polygon from mouse clicked points
                    ...
                    pygame.draw.polygon(self.screen, self.BLUE, poly_vertices)
                    pygame.display.update()
                    poly_vertices = []
        return obstacles
    ...
    def draw_polygon(self, vertices, color=RED):
        ...
        :return:
        """
        pygame.draw.polygon(self.screen, self.BLUE, vertices)
        pygame.display.update()
